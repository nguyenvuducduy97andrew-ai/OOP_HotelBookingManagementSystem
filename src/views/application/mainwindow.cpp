    ...
    , m_manager(manager)
{
    ...
    this->setWindowTitle("Hotel Management System");
     // Brand header (Icon + Tên đồ án) at top-left corner
    auto* brandContainer = new QWidget(ui->sidebarFrame);
    brandContainer->setObjectName("brandContainer");
    auto* brandLayout = new QHBoxLayout(brandContainer);
    brandLayout->setContentsMargins(6, 6, 6, 18);
    brandLayout->setSpacing(10);

    auto* logoLabel = new QLabel("🏨", brandContainer);
    logoLabel->setObjectName("brandLogo");
    logoLabel->setAlignment(Qt::AlignCenter);
    logoLabel->setFixedSize(38, 38);
    logoLabel->setStyleSheet(
        "QLabel#brandLogo {"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #005BFE, stop:1 #1D4ED8);"
        "   color: #FFFFFF;"
        "   border-radius: 10px;"
        "   font-size: 20px;"
        "}"
    ...
    auto* textContainer = new QWidget(brandContainer);
    ...
    auto* subtitleLabel = new QLabel("Hotel Management", textContainer);
    subtitleLabel->setObjectName("brandSubtitle");
    subtitleLabel->setStyleSheet("QLabel#brandSubtitle { font-size: 11px; font-weight: 600; color: #64748B; background: transparent; border: none; }");

    textLayout->addWidget(titleLabel);
    textLayout->addWidget(subtitleLabel);

    brandLayout->addWidget(logoLabel);
    brandLayout->addWidget(textContainer, 1);

    ui->verticalLayout_2->insertWidget(0, brandContainer);
