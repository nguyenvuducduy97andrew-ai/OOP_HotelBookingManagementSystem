...
bool RoomManager::confirmMaintenance(const std::string& maintenanceId, std::string& errorMessage) { return m_roomService.confirmMaintenance(maintenanceId, errorMessage); }
